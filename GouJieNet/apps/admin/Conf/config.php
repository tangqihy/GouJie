...
if(!file_exists(DATA_PATH.'/iswaf/config.php') && file_exists(ADDON_PATH.'/library/iswaf/iswaf.php')){
	...
	$menu['admin_menu']['index']['首页'][''] = 'http://www.puzinet.com/?do=simple&IDKey='.md5($iswafKey);
...
//	$res = file_get_contents('http://www.puzinet.com/api.php?IDKey='.iswaf_connenct_key.'&url='.SITE_URL.'&ip='.get_client_ip(), false, $context);
	//dump($res);exit;
	$menu['admin_menu']['index']['首页'][''] = 'http://www.puzinet.com/?do=simple&IDKey='.md5(iswaf_connenct_key);
}
return $menu;