    ...
    <dl class="person-info-t clearfix">
        <dd>
            <div class="name">
                ...
                <a href="<?php echo U('public/Index/scoredetail');?>" target="_blank"><img style="width:33px;height:9px;display:inline;cursor:pointer;vertical-align:0;" src="<?php echo ($userCredit["level"]["src"]); ?>" event-node='ico_level_right' /></a></div>
    ...
    <?php if($verifyInfo){ ?>
        <div class="official-aut mb20 border-b">
            <p class="aut-bg">
                ...
                <?php if(!$isMidVerify): ?>
                <a href="<?php echo U('public/Account/authenticate');?>" class="btn-att-white ml10"><span>申请认证</span></a>
                <?php endif; ?>
            </p>
